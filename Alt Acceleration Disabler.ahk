...
SendMode Input  ;Menu, Tray, Icon, shell32.dll, 110 ; changes the icon to a (\) thingy
...
; !w::msgbox,,,horray for having control of your own computer,0.7 Recommended for new scripts due to its superior speed and reliability.
SetWorkingDir %A_ScriptDir%  ; Ensures a consistent starting directory.
