...
#define LM_LSFT  LM(_ShiftFix, MOD_LSFT)
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_MTGAP] = LAYOUT(
     KC_TAB , KC_Y ,  KC_P  ,  KC_O  ,   KC_U , KC_J   ,                                      KC_K  ,  KC_D  ,  KC_L  ,  KC_C  ,  KC_W  , KC_DEL ,
       MIR  , KC_I ,  KC_N  ,  KC_E  ,   KC_A , KC_DOT ,                                      KC_M  ,  KC_H  ,  KC_T  ,  KC_S  ,  KC_R  , KC_ENT ,
     LM_LCTL, KC_Q ,  KC_Z  , KC_QUOT, KC_COMM, KC_SCLN, KC_ESC ,  FKEY  , KC_F13 , KC_CAPS,  KC_B  ,  KC_F  ,  KC_G  ,  KC_V  ,  KC_X  , LM_RCTL,
                             LM_LGUI , LM_LALT, LM_LSFT, KC_SPC ,  NAVL  ,  NAVR  , KC_BSPC, KC_RSFT,  LM_RALT, KC_APP
    ),

    [_QWERTY] = LAYOUT(
     _______,   KC_Q ,   KC_W ,  KC_E  ,   KC_R ,   KC_T ,                                       KC_Y ,   KC_U ,   KC_I ,   KC_O ,   KC_P , _______,
       QMIR ,   KC_A ,   KC_S ,  KC_D  ,   KC_F ,   KC_G ,                                       KC_H ,   KC_J ,   KC_K ,   KC_L , KC_SCLN, _______,
     KC_LCTL,   KC_Z ,   KC_X ,  KC_C  ,   KC_V ,   KC_B , KC_ESC , _______, _______, _______,   KC_N ,   KC_M , KC_COMM, KC_DOT , KC_SLSH, KC_RCTL,
                                KC_LGUI, KC_LALT, _______, _______, _______, _______, _______, KC_RSFT, KC_RALT, _______
    ),
    ...
    [_QWERTY2] = LAYOUT(
     _______,   KC_Q ,   KC_W ,  KC_E  ,   KC_R ,   KC_T ,                                       KC_Y ,   KC_U ,   KC_I ,   KC_O ,   KC_P , _______,
       QMIR ,   KC_A ,   KC_S ,  KC_D  ,   KC_F ,   KC_G ,                                       KC_H ,   KC_J ,   KC_K ,   KC_L , KC_SCLN, _______,
     KC_LCTL,   KC_Z ,   KC_X ,  KC_C  ,   KC_V ,   KC_B , KC_ESC , _______, _______, _______,   KC_N ,   KC_M , KC_COMM, KC_DOT , KC_SLSH, KC_RCTL,
                                KC_LGUI, KC_LALT, KC_LSFT, _______, _______, _______, _______, _______, KC_RALT, _______
    ),
    ...
    [_GAMING] = LAYOUT(
     ...
     KC_LCTL, KC_LSFT,   KC_A ,   KC_S ,   KC_D ,   KC_F ,                                       KC_H ,   KC_J ,   KC_K ,   KC_L , KC_SCLN, _______,
       KC_G ,   KC_B ,   KC_Z ,   KC_X ,   KC_C ,   KC_V , KC_ESC , _______, _______, _______,   KC_N ,   KC_M , KC_COMM, KC_DOT , KC_SLSH, KC_RCTL,
                                  KC_APP, KC_LALT,  GMIR , KC_SPC ,  NAVL  , _______, _______, _______, LM_RALT, _______
    ),

    [_MIR] = LAYOUT(
     S(KC_TAB), KC_W  ,  KC_C  ,  KC_L  ,  KC_D  ,  KC_K  ,                                      _______, KC_AMPR, KC_ASTR, KC_LPRN, _______, _______,
     KC_ENT	 ,  KC_R  ,  KC_S  ,  KC_T  ,  KC_H  ,  KC_M  ,                                      _______, KC_DLR , KC_PERC, KC_CIRC, KC_RPRN, _______,
     LMM_RCTL,  KC_X  ,  KC_V  ,  KC_G  ,  KC_F  ,  KC_B  ,  _______,   NPAD , _______,   RARW , _______, KC_EXLM,  KC_AT , KC_HASH, _______, _______,
                                 KC_APP , LMM_RALT, _______, KC_BSPC, _______, _______, _______, _______, _______, _______
    ),

    [_GMIR] = LAYOUT(
      S(KC_TAB),  KC_P ,  KC_O  , KC_I   ,  KC_U  ,  KC_Y  ,                                     KC_NUM ,  KC_P7 ,  KC_P8 ,  KC_P9 , KC_PPLS, _______,
      KC_ENT ,  KC_SCLN,  KC_L  , KC_K   ,  KC_J  ,  KC_H  ,                                     KC_PAST,  KC_P4 ,  KC_P5 ,  KC_P6 ,  KC_P0 , KC_PENT,
      KC_RCTL,  KC_COMM,  KC_DOT, KC_COMM,  KC_M  ,  KC_N  , _______,   NPAD , _______,   RARW , KC_PSLS,  KC_P1 ,  KC_P2 ,  KC_P3 , KC_PMNS, _______,
                                  KC_RGUI, KC_RALT, KC_BSPC, _______, _______, _______, _______, KC_PDOT, _______, _______
    ),
	
    [_QMIR] = LAYOUT(
    S(KC_TAB),  KC_P   ,  KC_O  , KC_I   ,  KC_U  ,  KC_Y  ,                                     _______, KC_AMPR, KC_ASTR, KC_LPRN, _______, _______,
      KC_ENT ,  KC_SCLN,  KC_L  , KC_K   ,  KC_J  ,  KC_H  ,                                     _______, KC_DLR , KC_PERC, KC_CIRC, KC_RPRN, _______,
      KC_RCTL,  KC_COMM,  KC_DOT, KC_COMM,  KC_M  ,  KC_N  , _______,   NPAD , _______,   RARW , _______, KC_EXLM,  KC_AT , KC_HASH, _______, _______,
                                  KC_APP , KC_RALT, _______, KC_BSPC, _______, _______, _______, _______, _______, _______
    ),
	...
	[_ShiftFix] = LAYOUT(
      ...
      _______, _______, _______, _______, _______, _______,                                     _______, _______, _______, _______, _______, _______,
      _______, _______, _______, _______, _______, _______, _______, KC_SLEP, _______, _______, _______, _______, _______, _______, _______, _______,
                                 _______, _______, _______, _______, _______, _______, _______, _______, _______, _______
    ),
	
	[_NAVL] = LAYOUT(
      KC_DEL , KC_MS_L, KC_MS_D, KC_MS_U, KC_MS_R , KC_BTN1,                                     KC_NUM ,  KC_P7 ,  KC_P8 ,  KC_P9 , KC_PPLS, _______,
      HM_ENT , KC_LEFT, KC_DOWN,  KC_UP , KC_RIGHT, KC_VOLU,                                     KC_PAST,  KC_P4 ,  KC_P5 ,  KC_P6 ,  KC_P0 , KC_PENT,
      _______,   NAV2 , KC_MPRV, KC_MPLY, KC_MNXT , KC_VOLD, GAMING ,  NPAD  , _______, KC_SCRL, KC_PSLS,  KC_P1 ,  KC_P2 ,  KC_P3 , KC_PMNS, _______,
                                 _______, _______ , TGGAME , _______, _______,  FKEY  , _______, KC_PDOT, _______, _______
    ),
	
	[_NAVR] = LAYOUT(
      KC_LBRC, KC_RBRC, KC_LPRN, KC_RPRN, KC_LCBR, KC_RCBR,                                        KC_BTN1, KC_MS_L, KC_MS_U, KC_MS_D, KC_MS_R , KC_BTN3,
      _______,UC(0x00B0), KC_EQL , KC_MINS, KC_QUES, KC_GRV,                                       KC_VOLU, KC_LEFT, KC_UP  , KC_DOWN, KC_RIGHT, _______,
      _______,UC(0x00B3),UC(0x00B2),KC_UNDS, KC_SLSH, KC_BSLS, KC_SCRL, KC_SLEP,  FKEY  , _______, KC_VOLD, KC_MPRV, KC_MPLY, KC_MNXT,   NAV2  , _______,
	...
	[_NPAD] = LAYOUT(
      KC_TAB , KC_PPLS,  KC_7  ,  KC_8  ,  KC_9  , KC_BSPC,                                     _______, _______, _______, _______, _______, _______,
      HM_ENT ,  KC_0  ,  KC_4  ,  KC_5  ,  KC_6  , KC_ASTR,                                     _______, _______, _______, _______, _______, _______,
      LM_PCTL, KC_MINS,  KC_1  ,  KC_2  ,  KC_3  , KC_SLSH,  MTGAP ,  _______, _______, PLOVER , _______, _______, _______, _______, _______, _______,
                                 LM_PGUI, LM_PALT, _______, _______,  _______, _______, _______, _______, _______, _______
    ),
    ...
    [_FKEY] = LAYOUT(
      KC_DEL , KC_F10 ,  KC_F7 ,  KC_F8 ,  KC_F9 , KC_F13 ,                                     KC_PSCR, KC_F7 ,  KC_F8 ,  KC_F9 ,  KC_F10 , _______,
      KC_LSFT, KC_F11 ,  KC_F4 ,  KC_F5 ,  KC_F6 , KC_HOME,                                     KC_PGUP, KC_F4 ,  KC_F5 ,  KC_F6 ,  KC_F11 , KC_RSFT,
      _______, KC_F12 ,  KC_F1 ,  KC_F2 ,  KC_F3 , KC_END ,  MTGAP , _______, _______, PLOVER , KC_PGDN, KC_F1 ,  KC_F2 ,  KC_F3 ,  KC_F12 , _______,
...
// bool process_record_user(uint16_t keycode, keyrecord_t *record) {
    ...
    // return true;
// }
const key_override_t numpad0_override = ko_make_basic(MOD_MASK_SHIFT, KC_P0, KC_RCBR);
...
const key_override_t numpad9_override = ko_make_basic(MOD_MASK_SHIFT, KC_P9, KC_LCBR);
