...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_MTGAP] = LAYOUT(
     ...
     KC_LSFT, KC_I ,  KC_N  ,  KC_E  ,   KC_A , KC_DOT ,                                     KC_M  ,  KC_H  ,  KC_T  ,  KC_S  ,  KC_R  , HM_ENT ,
    ...
    [_GAMING] = LAYOUT(
     ...
     KC_LCTL, KC_LSFT,   KC_A ,   KC_S ,   KC_D ,   KC_F ,                                       KC_H ,   KC_J ,   KC_K ,   KC_L , KC_SCLN, _______,
       KC_G ,   KC_B ,   KC_Z ,   KC_X ,   KC_C ,   KC_V , KC_ESC , _______, _______, _______,   KC_N ,   KC_M , KC_COMM, KC_DOT , KC_SLSH, KC_RCTL,
                                  KC_APP, KC_LALT,   NAV , KC_SPC ,  GMIR  , _______, _______, _______, LM_RALT, _______
    ),
    ...
    [_MIR] = LAYOUT(
     ...
     LMM_RCTL,  KC_X  ,  KC_V  ,  KC_G  ,  KC_F  ,  KC_B  ,  _______,   NPAD , _______,   RARW , KC_PSLS,  KC_P1 ,  KC_P2 ,  KC_P3 , KC_PMNS, _______,
                                 KC_CAPS, LMM_RALT, KC_BSPC, _______, _______,  FKEY  , _______, KC_PDOT, _______, _______
    ),
    ...
    [_GMIR] = LAYOUT(
      ...
      HM_ENT ,  KC_SCLN,  KC_L  , KC_K   ,  KC_J  ,  KC_H  ,                                     KC_PAST,  KC_P4 ,  KC_P5 ,  KC_P6 ,  KC_P0 , KC_PENT,
	...
	[_NPAD] = LAYOUT(
      ...
      _______, KC_MINS,  KC_1  ,  KC_2  ,  KC_3  , KC_SLSH, KC_CAPS,  _______, PLOVER , _______, _______, _______, _______, _______, _______, _______,
                                 LM_LGUI, _______, _______, _______,   FKEY  , _______, _______, _______, _______, _______
    ),
	
	// [_NPAD2] = LAYOUT(
      // KC_DEL , KC_RPRN, KC_AMPR, KC_ASTR, KC_QUES, KC_UNDS,                                     _______, _______, _______, _______, _______, _______,
      // HM_ENT , KC_PDOT, KC_DLR , KC_PERC, KC_CIRC, KC_RCBR,                                     _______, _______, _______, _______, _______, _______,
      // LM_PCTL, KC_LPRN, KC_EXLM,  KC_AT , KC_HASH, KC_LCBR,  MTGAP , _______, _______, _______, _______, _______, _______, _______, _______, _______,
                                 // LM_PGUI, LM_PALT, KC_BSPC, _______, XXXXXXX, _______, _______, _______, _______, _______
    // ),
	...
	// [_BLOCK] = LAYOUT(
      ...
      // _______, _______, _______, _______, _______, _______,                                     _______, _______, _______, _______, _______, _______,
      // _______, _______, _______, _______, _______, _______,  MTGAP , _______, _______, _______, _______, _______, _______, _______, _______, _______,
                                 // KC_APP , _______, _______, _______, XXXXXXX, _______, _______, _______, _______, _______
    // ),
    ...
    [_SYM] = LAYOUT(
      ...
      SC_LCPO, UC(0x00B0), UC(0x200B), KC_QUES, KC_SLSH, KC_LPRN, _______, _______,  FKEY , KC_SCRL, KC_RPRN, KC_BSLS, KC_PIPE, UC(0x00B2), UC(0x00B3), SC_RCPC,
                                 _______, SC_LAPO, _______, _______,   FKEY , _______, _______, _______, SC_RAPC, _______
    ),
	
    [_FKEY] = LAYOUT(
      KC_DEL , KC_F10 ,  KC_F7 ,  KC_F8 ,  KC_F9 , KC_F13 ,                                     KC_PSCR, KC_F7 ,  KC_F8 ,  KC_F9 ,  KC_F10 , KC_DEL ,
      HM_ESC , KC_F11 ,  KC_F4 ,  KC_F5 ,  KC_F6 , KC_HOME,                                     KC_PGUP, KC_F4 ,  KC_F5 ,  KC_F6 ,  KC_F11 , HM_ENT ,
      KC_LSFT, KC_F12 ,  KC_F1 ,  KC_F2 ,  KC_F3 , KC_END ,  MTGAP , _______, _______, PLOVER , KC_PGDN, KC_F1 ,  KC_F2 ,  KC_F3 ,  KC_F12 , KC_RSFT,
