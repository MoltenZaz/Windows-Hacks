...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_GAMING] = LAYOUT(
     ...
     KC_LCTL, KC_LSFT,   KC_A ,   KC_S ,   KC_D ,   KC_F ,                                       KC_H ,   KC_J ,   KC_K ,   KC_L , KC_SCLN, _______,
       KC_G ,   KC_B ,   KC_Z ,   KC_X ,   KC_C ,   KC_V , KC_ESC , NPADG , _______, _______,   KC_N ,   KC_M , KC_COMM, KC_DOT , KC_SLSH, KC_RCTL,
	...
	[_NPAD] = LAYOUT(
      ...
      LM_PCTL, KC_MINS,  KC_1  ,  KC_2  ,  KC_3  , KC_SLSH, ESCPAD ,  NPAD2 , _______, _______, _______, _______, _______, _______, _______, _______,
                                 LM_PGUI, LM_PALT,   NAV  , _______,  KC_MFX, _______, _______, _______, _______, _______
    ),
