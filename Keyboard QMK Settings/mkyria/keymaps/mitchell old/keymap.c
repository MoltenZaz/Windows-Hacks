...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_MTGAP] = LAYOUT(
     ...
     LM_LCTL, KC_Q ,  KC_Z   ,  KC_QUOT,  KC_COMM, KC_SCLN, KC_ESC,  NPAD2 ,     KC_F13  , KC_DEL , KC_B,    KC_F ,  KC_G ,   KC_V ,  KC_X, LM_RCTL,
	...
	[_HRMOD] = LAYOUT(
     ...
     _______, _______, _______, _______,      _______, _______,                                     _______, _______, _______, _______, _______, _______,
     _______, HOME_Q,  HOME_Z, HOME_QUOTE, HOME_COMMA, _______, _______, _______, _______, _______, _______, HOME_F , HOME_G , HOME_V , HOME_X , _______,
                                     _______, _______, _______, _______,  HRMIR , _______, _______, _______, _______, _______
    ),
    ...
    [_QWERTY] = LAYOUT(
     ...
     KC_LCTL, KC_Z ,  KC_X   ,  KC_C  ,   KC_V ,   KC_B , _______, _______, _______, _______, KC_N,    KC_M ,   KC_COMM, KC_DOT ,KC_SLSH, KC_LCTL,
	...
	[_QWERTY2] = LAYOUT(
     _______, KC_Q ,  KC_W   ,  KC_E  ,   KC_R ,   KC_T ,                                     KC_Y,    KC_U ,   KC_I ,   KC_O ,  KC_P ,   _______,
     KC_LSFT, KC_A ,  KC_S   ,  KC_D  ,   KC_F ,   KC_G ,                                     KC_H,    KC_J ,   KC_K ,   KC_L ,  KC_SCLN, KC_RSFT,
     KC_LCTL, KC_Z ,  KC_X   ,  KC_C  ,   KC_V ,   KC_B , _______, _______, _______, _______, KC_N,    KC_M ,   KC_COMM, KC_DOT ,KC_SLSH, KC_RCTL,
    ...
    [_GAMING] = LAYOUT(
     ...
     KC_G    , KC_B    , KC_Z ,  KC_X   ,  KC_C  ,   KC_V , KC_ESC , NPAD2  ,     _______, _______, KC_N,    KC_M ,  KC_6 , KC_7 , KC_8 , KC_RCTL,
	...
	[_NPMOD] = LAYOUT(
     _______, _______, _______, _______, _______, _______,                                     _______, _______, _______, _______, _______, _______,
     _______, _______, _______, _______, _______, _______,                                     _______, _______, _______, _______, _______, _______,
     _______, _______, _______, _______, _______, _______, _______,   NAV  , _______, _______, _______, _______, _______, _______, _______, _______,
                                _______, _______,  NPAD  , _______, _______, _______, _______, _______, _______, _______
    ),
	
	
    [_MIR] = LAYOUT(
      KC_ENT ,  KC_W  ,  KC_C  ,  KC_L  ,  KC_D  ,  KC_K  ,                                      KC_NUM ,  KC_P7 ,  KC_P8 ,  KC_P9 , KC_PPLS, KC_PENT,
      SC_RSPC,  KC_R  ,  KC_S  ,  KC_T  ,  KC_H  ,  KC_M  ,                                      KC_PAST,  KC_P4 ,  KC_P5 ,  KC_P6 ,  KC_P0 , KC_PENT,
      LMM_RCTL, KC_X  ,  KC_V  ,  KC_G  ,  KC_F  ,  KC_B  ,  _______,   FKEY ,   NMOD ,   RARW , KC_PSLS,  KC_P1 ,  KC_P2 ,  KC_P3 , KC_PMNS, _______,
	...
	[_HRMIR] = LAYOUT(
      KC_ENT ,  KC_W  ,  KC_C  ,  KC_L  ,  KC_D  ,  KC_K  ,                                      KC_NUM ,  KC_P7 ,  KC_P8 ,  KC_P9 , KC_PPLS, KC_PENT,
      SC_RSPC,  KC_R  ,  KC_S  ,  KC_T  ,  KC_H  ,  KC_M  ,                                      KC_PAST,  KC_P4 ,  KC_P5 ,  KC_P6 ,  KC_P0 , KC_PENT,
      LMM_RCTL, HOME_X,  HOME_V,  HOME_G,  HOME_F,  KC_B  ,  _______,   FKEY ,   NMOD ,   RARW , KC_PSLS,  KC_P1 ,  KC_P2 ,  KC_P3 , KC_PMNS, _______,
                                 KC_APP , LMM_RALT, KC_BSPC, _______, _______, _______, _______,  KC_P0 , KC_PDOT, _______
    ),
	
    [_DMIR] = LAYOUT(
      KC_ENT ,  KC_L  ,  KC_R  ,  KC_C  ,  KC_G  ,  KC_F   ,                                     KC_NUM ,  KC_P7 ,  KC_P8 ,  KC_P9 , KC_PPLS, KC_PENT,
      SC_RSPC,  KC_S  ,  KC_N  ,  KC_T  ,  KC_H  ,  KC_D   ,                                     KC_PAST,  KC_P4 ,  KC_P5 ,  KC_P6 ,  KC_P0 , KC_PENT,
      LMM_RCTL, KC_Z  ,  KC_V  ,  KC_W  ,  KC_M  ,  KC_B   , _______,   FKEY ,   NMOD ,   RARW , KC_PSLS,  KC_P1 ,  KC_P2 ,  KC_P3 , KC_PMNS, _______,
                                 KC_APP , LMM_RALT, KC_BSPC, _______, _______, _______, _______,  KC_P0 , KC_PDOT, _______
    ),

    [_GMIR] = LAYOUT(
      KC_ENT ,  KC_P   ,  KC_O  , KC_I   ,  KC_U  ,  KC_Y  ,                                     KC_NUM ,  KC_P7 ,  KC_P8 ,  KC_P9 , KC_PPLS, KC_PENT,
      KC_RSFT,  KC_SCLN,  KC_L  , KC_K   ,  KC_J  ,  KC_H  ,                                     KC_PAST,  KC_P4 ,  KC_P5 ,  KC_P6 ,  KC_P0 , KC_PENT,
      KC_RCTL,  KC_COMM,  KC_DOT, KC_COMM,  KC_M  ,  KC_N  , _______,   FKEY ,   NMOD ,   RARW , KC_PSLS,  KC_P1 ,  KC_P2 ,  KC_P3 , KC_PMNS, _______,
	...
	[_NPAD2] = LAYOUT(
      KC_ENT , KC_RBRC, KC_AMPR, KC_ASTR, KC_QUES, KC_BSPC,                                     _______, _______, _______, _______, _______, _______,
      SC_RCPC, KC_PDOT, KC_DLR , KC_PERC, KC_CIRC, KC_RCBR,                                     _______, _______, _______, _______, _______, _______,
      _______, KC_LBRC, KC_EXLM,  KC_AT , KC_HASH, KC_LCBR,  MTGAP , _______, _______, _______, _______, _______, _______, _______, _______, _______,
                                 _______, _______, KC_BSPC, _______,   NPAD , _______, _______, _______, _______, _______
    ),
	
	[_NPAD] = LAYOUT(
      KC_ENT , KC_PPLS,  KC_7  ,  KC_8  ,  KC_9  , KC_BSPC,                                     _______, _______, _______, _______, _______, _______,
      SC_LCPO,  KC_0  ,  KC_4  ,  KC_5  ,  KC_6  , KC_ASTR,                                     _______, _______, _______, _______, _______, _______,
      _______, KC_MINS,  KC_1  ,  KC_2  ,  KC_3  , KC_SLSH, _______,  NPAD2 , _______, _______, _______, _______, _______, _______, _______, _______,
                                 _______, KC_PDOT, TGNPAD , _______, KC_MFX , _______, _______, _______, _______, _______
    ),
	...
	[_NAV] = LAYOUT(
      ...
      KC_LCTL,   NAV2 , KC_MPRV, KC_MPLY, KC_MNXT , KC_VOLD,  HRMOD , KC_SLEP, _______, _______, KC_VOLD, KC_MPRV, KC_MPLY, KC_MNXT,   NAV2  , KC_RCTL,
                                 _______, _______ , KC_BSPC, _______, TGGAME , _______, _______, _______, _______, _______
    ),

	[_NAV2] = LAYOUT(
      PLOVER , C(G(KC_0)), C(G(KC_9)), C(G(KC_8)), C(G(KC_7)), C(G(KC_6)),                                     C(G(KC_5)), C(G(KC_4)), C(G(KC_3)), C(G(KC_2)), C(G(KC_1)), _______,
      _______, C(G(KC_1)), C(G(KC_2)), C(G(KC_3)), C(G(KC_4)), C(G(KC_5)),                                     C(G(KC_6)), C(G(KC_7)), C(G(KC_8)), C(G(KC_9)), C(G(KC_0)), _______,
	...
	[_SYM] = LAYOUT(
      KC_GRV , KC_EXLM,  KC_AT , KC_HASH, KC_DLR , KC_PERC,                                     KC_CIRC, KC_AMPR, KC_ASTR, KC_MINS, KC_EQL , KC_SCRL,
      SC_LAPO,  KC_1  ,  KC_2  ,  KC_3  ,  KC_4  ,  KC_5  ,                                      KC_6  ,  KC_7  ,  KC_8  ,  KC_9  ,  KC_0  , SC_RAPC,
      _______, KC_LBRC, KC_RBRC, KC_QUES, KC_SLSH, KC_UNDS, KC_CAPS, _______,   FKEY , KC_INS , KC_EQL , KC_BSLS, KC_PIPE, KC_LCBR, KC_RCBR, _______,
    ...
    [_FKEY] = LAYOUT(
      ...
      KC_LCTL, KC_F12 ,  KC_F1 ,  KC_F2 ,  KC_F3 , KC_END , KC_CAPS, _______, _______, PLOVER , KC_PGDN, KC_F1 ,  KC_F2 ,  KC_F3 ,  KC_F12 , KC_RCTL,
                                 KC_LGUI, KC_LALT, _______, _______, XXXXXXX, _______, _______, _______, KC_RALT, KC_RGUI
    ),
